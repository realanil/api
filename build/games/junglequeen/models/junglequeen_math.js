...
exports.JungleQueenMath = void 0;
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const platform_math_1 = require("../../../libs/platform/base/platform_math");
class JungleQueenMath extends platform_math_1.PlatformMath {
    constructor() {
        super();
        this.goldSymbolId = 14;
        this.mystrySymbolId = 13;
        this.goldMultiplier = [];
        this.defaultgrid = [
            [8, 12, 9],
            [6, 4, 2],
        ...
        this.info = {
            betMultiplier: new bignumber_js_1.default(20),
...
exports.JungleQueenMath = JungleQueenMath;
class GoldSets {
    constructor() {
        this.multipliers = [];
    }
